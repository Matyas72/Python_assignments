...
matyas.make_deposit(100).make_deposit(100).make_deposit(100)

matyas.make_withdrawal(200)

matyas.display_user_balance()

hillary.make_deposit(500).make_deposit(500)

hillary.make_withdrawal(200).make_withdrawal(200)

hillary.display_user_balance()

bryan.make_deposit(1000)

bryan.make_withdrawal(300).make_withdrawal(300).make_withdrawal(300)
